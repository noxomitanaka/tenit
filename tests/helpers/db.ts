...
import { users, clubSettings, members, groups, courts, lessons, lessonSlots, reservations, substitutionCredits, memberGroups, accounts, sessions, verificationTokens, tournaments, tournamentEntries, tournamentMatches, attendances, broadcastMessages } from '@/db/schema';
